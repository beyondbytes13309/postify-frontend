      ...
      <div className={styles.wrapper}>
        <div className={styles.form}>
          ...
          <p className={styles.errors}>
            {errors[type == "signin" ? "username" : "email"]} &#8203;
          </p>
          ...
          <div className={styles.social_buttons}>
            ...
            <button
              onClick={() => handleAuth("google_auth")}
              className={styles.google_btn}
            >
              <img src={googleIcon} className={styles.google_icon} /> Google
            </button>
            <button
              onClick={() => handleAuth("github_auth")}
          ...
          <p onClick={toggleMethod} className={styles.auth_toggle_text}>
            {type == "signin"
